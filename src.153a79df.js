...
},{"fbjs/lib/invariant":16,"fbjs/lib/warning":13,"./lib/ReactPropTypesSecret":25}],11:[function(require,module,exports) {
...
},{"object-assign":14,"fbjs/lib/invariant":16,"fbjs/lib/emptyObject":15,"fbjs/lib/warning":13,"fbjs/lib/emptyFunction":17,"prop-types/checkPropTypes":18}],7:[function(require,module,exports) {
'use strict';
...
},{"fbjs/lib/invariant":16,"react":7,"fbjs/lib/warning":13,"fbjs/lib/ExecutionEnvironment":19,"object-assign":14,"fbjs/lib/emptyFunction":17,"prop-types/checkPropTypes":18,"fbjs/lib/getActiveElement":20,"fbjs/lib/shallowEqual":21,"fbjs/lib/containsNode":22,"fbjs/lib/emptyObject":15,"fbjs/lib/hyphenateStyleName":23,"fbjs/lib/camelizeStyleName":24}],8:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":12}],31:[function(require,module,exports) {
"use strict";
...
var cartesionProduct = function cartesionProduct(a, b) {
    var _ref;
...
var expressions = ['((%i1% %op1% %i2%) %op2% %i3%) %op3% %i4%', '(%i1% %op1% (%i2% %op2% %i3%)) %op3% %i4%', '(%i1% %op1% %i2%) %op2% (%i3% %op3% %i4%)', '%i1% %op1% ((%i2% %op2% %i3%) %op3% %i4%)', '%i1% %op1% (%i2% %op2% (%i3% %op3% %i4%))'];
var operators = ['+', '-', '*', '/'];
exports.operatorsPermutations = cartesionProduct(cartesionProduct(operators, operators), operators);
var buildReplacements = function buildReplacements(calculationArray) {
    var _calculationArray = _slicedToArray(calculationArray, 8),
        _ = _calculationArray[0],
        op1 = _calculationArray[1],
        op2 = _calculationArray[2],
        op3 = _calculationArray[3],
        i1 = _calculationArray[4],
        i2 = _calculationArray[5],
        i3 = _calculationArray[6],
        i4 = _calculationArray[7];
...
function random() {
    var randomInput = [1, 1, 1, 1];
    while (solve(randomInput).length === 0) {
        randomInput = [].concat(_toConsumableArray(new Array(4))).map(function (x) {
...
function solve(input) {
    var calculationArrays = cartesionProduct(cartesionProduct(expressions, exports.operatorsPermutations), uniquePermutations(input));
    var solutions = calculationArrays.map(function (calculationArray) {
        var replacements = buildReplacements(calculationArray);

        var _calculationArray2 = _toArray(calculationArray),
            expression = _calculationArray2[0],
            rest = _calculationArray2.slice(1);

        var calculation = expression.replace(/%\w+%/g, function (placeholder) {
...
exports.solve = solve;
function uniquePermutations(input) {
    var output = [].concat(_toConsumableArray(new Set(permutations(input).map(function (permutation) {
        return permutation.join(',');
    })))).map(function (inputString) {
        return inputString.split(',').map(function (stringNumber) {
            return parseInt(stringNumber, 10);
        });
    });
    // Ensure type
    return output.map(function (numbers) {
        return [numbers[0] || 1, numbers[1] || 1, numbers[2] || 1, numbers[3] || 1];
    });
}
exports.uniquePermutations = uniquePermutations;
...
var _24Solver_1 = require("./24Solver");
...
var App = function (_react_1$default$Comp) {
    ...
    _createClass(App, [{
        ...
        value: function random() {
            var game = _24Solver_1.random();
            this.setState({
                game: game,
                solutions: _24Solver_1.solve(game)
            });
        }
    }, {
        key: "render",
        value: function render() {
            ...
            var _state$game = _slicedToArray(this.state.game, 4),
                i1 = _state$game[0],
                i2 = _state$game[1],
                i3 = _state$game[2],
                i4 = _state$game[3];

            return react_1.default.createElement("div", null, react_1.default.createElement("h1", null, "24 Game"), react_1.default.createElement("div", null, react_1.default.createElement("button", { onClick: this.random }, "Generate!")), react_1.default.createElement("ul", null, react_1.default.createElement("li", null, i1), react_1.default.createElement("li", null, i2), react_1.default.createElement("li", null, i3), react_1.default.createElement("li", null, i4)), react_1.default.createElement("ul", null, solutions.map(function (solution) {
                return react_1.default.createElement("li", { key: solution }, solution);
            })));
        }
    }]);
...
},{"react":7,"react-dom":8,"./24Solver":31}],33:[function(require,module,exports) {
...
//# sourceMappingURL=/src.153a79df.map